...
function Nav() {
  ...
  const [classContainerLink, setClassContainerLink] = useState('NavContainerLink unclicked')
    ...
    <div className='NavBar'>
      <div className='NavContainer'>
        ...
        { displayMenuButton ? (
          ...
          <MdClose className='NavDisplayMenuButton' onClick={updateMenuButton}/>
        }
      </div>
      <div className='NavContainerSearch'>
          <input type="text" id='txt' className='NavSearchBar' placeholder='HOLA'/>
      </div>
